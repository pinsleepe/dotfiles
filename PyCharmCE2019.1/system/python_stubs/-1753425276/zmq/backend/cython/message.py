...
# from /home/mono/anaconda3/envs/twitter/lib/python3.6/site-packages/zmq/backend/cython/message.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
...
class Event(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'threading', '__doc__': 'Class implementing event objects.\\n\\n    Events manage a flag that can be set to true with the set() method and reset\\n    to false with the clear() method. The wait() method blocks until the flag is\\n    true.  The flag is initially false.\\n\\n    ', '__init__': <function Event.__init__ at 0x7f2577be1400>, '_reset_internal_locks': <function Event._reset_internal_locks at 0x7f2577be1488>, 'is_set': <function Event.is_set at 0x7f2577be1510>, 'isSet': <function Event.is_set at 0x7f2577be1510>, 'set': <function Event.set at 0x7f2577be1598>, 'clear': <function Event.clear at 0x7f2577be1620>, 'wait': <function Event.wait at 0x7f2577be16a8>, '__dict__': <attribute '__dict__' of 'Event' objects>, '__weakref__': <attribute '__weakref__' of 'Event' objects>})"
...
class Message(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f2577898510>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f2577930a20>'

__spec__ = None # (!) real value is "ModuleSpec(name='zmq.backend.cython.message', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f2577930a20>, origin='/home/mono/anaconda3/envs/twitter/lib/python3.6/site-packages/zmq/backend/cython/message.cpython-36m-x86_64-linux-gnu.so')"
