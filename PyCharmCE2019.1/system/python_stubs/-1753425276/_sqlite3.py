# encoding: utf-8
# module _sqlite3
# from /home/mono/anaconda3/envs/twitter/lib/python3.6/lib-dynload/_sqlite3.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
adapters = {
    (
        ...
        None # (!) real value is '<function register_adapters_and_converters.<locals>.adapt_date at 0x7f98e5395bf8>'
    ,
    (
        None, # (!) real value is "<class 'datetime.datetime'>"
        '<value is a self-reference, replaced by this string>',
    ): 
        None # (!) real value is '<function register_adapters_and_converters.<locals>.adapt_datetime at 0x7f98e5395598>'
    ,
}

converters = {
    'DATE': None, # (!) real value is '<function register_adapters_and_converters.<locals>.convert_date at 0x7f98e53957b8>'
    'TIMESTAMP': None, # (!) real value is '<function register_adapters_and_converters.<locals>.convert_timestamp at 0x7f98e5395620>'
}

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f98e528e668>'

__spec__ = None # (!) real value is "ModuleSpec(name='_sqlite3', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f98e528e668>, origin='/home/mono/anaconda3/envs/twitter/lib/python3.6/lib-dynload/_sqlite3.cpython-36m-x86_64-linux-gnu.so')"
