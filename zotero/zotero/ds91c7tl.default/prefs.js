...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1560850047);
user_pref("app.update.lastUpdateTime.background-update-timer", 1560850287);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1560850167);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1560871620);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1560850407);
...
user_pref("extensions.enabledAddons", "zoteroOpenOfficeIntegration%40zotero.org:5.0.15.SA.5.0.67,zotfile%40columbia.edu:5.0.10,storage-scanner%40iris-advies.com:5.0.8");
user_pref("extensions.lastAppVersion", "5.0.67");
user_pref("extensions.lastPlatformVersion", "52.9.0");
user_pref("extensions.pendingOperations", false);
user_pref("extensions.ui.dictionary.hidden", true);
user_pref("extensions.ui.locale.hidden", true);
user_pref("extensions.xpiState", "{\"app-profile\":{\"zotfile@columbia.edu\":{\"d\":\"/home/mono/.zotero/zotero/ds91c7tl.default/extensions/zotfile@columbia.edu.xpi\",\"e\":true,\"v\":\"5.0.10\",\"st\":1560714405000},\"storage-scanner@iris-advies.com\":{\"d\":\"/home/mono/.zotero/zotero/ds91c7tl.default/extensions/storage-scanner@iris-advies.com.xpi\",\"e\":true,\"v\":\"5.0.8\",\"st\":1560878868000}},\"app-global\":{\"zoteroOpenOfficeIntegration@zotero.org\":{\"d\":\"/opt/Zotero/extensions/zoteroOpenOfficeIntegration@zotero.org\",\"e\":true,\"v\":\"5.0.15.SA.5.0.67\",\"st\":1560709180000,\"mt\":1560709180000}}}");
...
user_pref("extensions.zotero.recentSaveTargets", "[{\"id\":\"C11\",\"sessionID\":\"CaKOvtPy\"}]");
user_pref("extensions.zotero.sourceList.persist", "{\"L1\":true,\"P1\":false,\"L3\":true,\"C8\":true}");
...
user_pref("idle.lastDailyNotification", 1560850942);
user_pref("intl.accept_languages", "en-US, en");
user_pref("media.gmp.storage.version.observed", 1);
user_pref("network.cookie.prefsMigrated", true);
user_pref("places.database.lastMaintenance", 1560850942);
user_pref("places.history.expiration.transient_current_max_pages", 122334);
user_pref("signon.importedFromSqlite", true);
user_pref("storage.vacuum.last.index", 0);
user_pref("storage.vacuum.last.places.sqlite", 1560850942);
